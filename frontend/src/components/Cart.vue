...
<template>
    ...
    >
        <!-- Header -->
        <div
            class="bg-linear-to-r from-green-50 to-blue-50 px-6 py-4 border-b border-gray-100"
        >
        ...
        <div v-if="cart.length === 0" class="p-6 text-center">
            <div
                class="w-24 h-24 mx-auto mb-6 bg-linear-to-br from-green-100 to-blue-100 rounded-full flex items-center justify-center"
            >
                <svg
            ...
            <!-- Call to Action -->
            <div
                class="bg-linear-to-r from-green-50 to-blue-50 rounded-lg p-4 border border-green-200"
            >
                ...
                <button
                    ...
                    class="bg-linear-to-r from-green-600 to-blue-600 hover:from-green-700 hover:to-blue-700 text-white px-6 py-3 rounded-lg font-semibold transition-all transform hover:scale-105 shadow-md"
                >
                    Browse Products
                </button>
            </div>
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="flex items-center space-x-3 mt-2">
                            ...
                            >
                                ...
                                <span
                                    class="px-3 py-1 bg-white text-sm font-medium min-w-8 text-center"
                                >
                                    {{ item.quantity }}
                                </span>
                                <button
