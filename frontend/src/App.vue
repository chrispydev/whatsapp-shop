...
<template>
  <div class="min-h-screen bg-white">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
          <div class="flex items-center">
            <div class="shrink-0">
              <a href="/" class="text-xl cursor-pointer font-bold text-gray-900">
                WhatsApp Shop
              </a>
            </div>
          </div>
    ...
    <!-- Hero Section -->
    <section class="relative bg-linear-to-br from-green-50 via-white to-blue-50 overflow-hidden">
      <div class="absolute inset-0">
        <div class="absolute inset-0 bg-linear-to-br from-green-400/10 to-blue-600/10"></div>
        <!-- Decorative elements -->
        <div class="absolute top-10 left-10 w-20 h-20 bg-green-200 rounded-full opacity-20 animate-pulse"></div>
        <div class="absolute top-40 right-20 w-32 h-32 bg-blue-200 rounded-full opacity-20 animate-pulse delay-1000">
        </div>
        <div
      ...
      <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
        <div class="text-center">
          <h1 class="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
            Shop Smart,
            <span class="text-transparent bg-clip-text bg-linear-to-r from-green-600 to-blue-600">
              Order Easy
            </span>
          </h1>
          ...
          <div
            ...
            <span class="text-sm text-gray-600">Order via WhatsApp</span>
          </div>

          <!-- Test WhatsApp Button -->
          <div class="mt-8">
            <button @click="testWhatsApp"
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div class="relative text-center">
            ...
            <div class="hidden md:block absolute top-8 left-1/2 w-full h-0.5 bg-gray-200 -z-10">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div class="lg:col-span-1">
            <div class="sticky top-24">
              <Cart :cart="cart" @update-quantity="updateCartQuantity" @remove-item="removeFromCart"
    ...
    <section class="py-16 bg-white">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          <!-- Testimonial 1 -->
          <div class="bg-linear-to-br from-green-50 to-green-100 rounded-2xl p-6 border border-green-200">
            ...
            <div class="flex items-center">
              <div class="w-10 h-10 bg-green-200 rounded-full flex items-center justify-center mr-3">
                <span class="text-green-700 font-semibold">KA</span>
              </div>
              <div>
          ...
          <!-- Testimonial 2 -->
          <div class="bg-linear-to-br from-blue-50 to-blue-100 rounded-2xl p-6 border border-blue-200">
            <div class="flex items-center mb-4">
              <div class="flex text-yellow-400">
                <svg v-for="i in 5" :key="i" class="w-4 h-4 fill-current" viewBox="0 0 20 20">
                  <path
            ...
            <div class="flex items-center">
              <div class="w-10 h-10 bg-blue-200 rounded-full flex items-center justify-center mr-3">
                <span class="text-blue-700 font-semibold">AO</span>
              </div>
              <div>
                <h4 class="font-semibold text-gray-900">
                  Ama Osei
          ...
          <!-- Testimonial 3 -->
          <div class="bg-linear-to-br from-purple-50 to-purple-100 rounded-2xl p-6 border border-purple-200">
            <div class="flex items-center mb-4">
              <div class="flex text-yellow-400">
                <svg v-for="i in 5" :key="i" class="w-4 h-4 fill-current" viewBox="0 0 20 20">
                  <path
            ...
            <div class="flex items-center">
              <div class="w-10 h-10 bg-purple-200 rounded-full flex items-center justify-center mr-3">
                <span class="text-purple-700 font-semibold">FK</span>
              </div>
              <div>
                <h4 class="font-semibold text-gray-900">
                  Fiifi Koomson
        ...
        <div class="mt-12 text-center">
          <div class="flex flex-wrap justify-center items-center gap-8 text-gray-500">
            <div class="flex items-center space-x-2">
              ...
              <span class="text-sm font-medium">5000+ Happy Customers</span>
            </div>
            <div class="flex items-center space-x-2">
              <svg class="w-5 h-5 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
            ...
            <div class="flex items-center space-x-2">
              ...
              <span class="text-sm font-medium">100% Secure Orders</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div v-if="isCartOpen" class="fixed inset-0 bg-black bg-opacity-50 z-50 lg:hidden" @click="toggleCart">
      <div
    ...
    <!-- Toast Notifications -->
    <Toast :show="showToast" :message="toastMessage" :type="toastType" @hide="hideToast" />
  </div>
</template>
