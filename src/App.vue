<template>
    <div class="min-h-screen bg-white">
        ...
        <!-- Hero Section -->
        <section
            class="relative bg-gradient-to-br from-green-50 via-white to-blue-50 overflow-hidden"
        >
            <div class="absolute inset-0">
                <div
                    class="absolute inset-0 bg-gradient-to-br from-green-400/10 to-blue-600/10"
                ></div>
                <!-- Decorative elements -->
                <div
            ...
            >
                <div class="text-center">
                    ...
                    >
                        <button
                            @click="scrollToProducts"
                            class="bg-green-600 hover:bg-green-700 text-white px-8 py-3 rounded-lg font-semibold transition-all transform hover:scale-105 shadow-lg"
                        >
                            Start Shopping
                        </button>
                        <a
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="relative text-center">
                        <div
                            class="w-16 h-16 bg-gradient-to-br from-green-400 to-green-600 rounded-full flex items-center justify-center mx-auto mb-4 text-white font-bold text-xl"
                        >
                            1
                        </div>
                        <h3 class="text-lg font-semibold text-gray-900 mb-2">
                    ...
                    <div class="relative text-center">
                        <div
                            class="w-16 h-16 bg-gradient-to-br from-blue-400 to-blue-600 rounded-full flex items-center justify-center mx-auto mb-4 text-white font-bold text-xl"
                        >
                            2
                        </div>
                        <h3 class="text-lg font-semibold text-gray-900 mb-2">
                    ...
                    <div class="text-center">
                        <div
                            class="w-16 h-16 bg-gradient-to-br from-purple-400 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-4 text-white font-bold text-xl"
                        >
                            3
                        </div>
                        <h3 class="text-lg font-semibold text-gray-900 mb-2">
...
const testWhatsApp = () => {
    const message = encodeURIComponent(
        "👋 Hello! I'm testing your WhatsApp Shop.\n\nI'm interested in learning more about your products. This is just a test message to see if the WhatsApp integration is working properly.\n\nThank you!",
    );
    const phoneNumber = "+233553782097"; // ⚠️ CHANGE THIS TO YOUR WHATSAPP NUMBER
